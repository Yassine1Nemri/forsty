...
class User implements UserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'sender', targetEntity: MessengerMessage::class, orphanRemoval: true)]
    private Collection $sentMessages;

    #[ORM\OneToMany(mappedBy: 'receiver', targetEntity: MessengerMessage::class, orphanRemoval: true)]
